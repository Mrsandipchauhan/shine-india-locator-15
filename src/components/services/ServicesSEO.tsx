...
const ServicesSEO = () => {
  return (
    <section className="prose prose-slate max-w-none mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <h3 className="text-xl md:text-2xl font-semibold mb-3">Exterior Detailing: Beyond Just Washing</h3>
      <p className="mb-6 leading-relaxed">
      ...
      <h3 className="text-xl md:text-2xl font-semibold mb-3">Interior Detailing: Creating a Clean, Healthy Cabin</h3>
      <p className="mb-6 leading-relaxed">
      ...
      <h3 className="text-xl md:text-2xl font-semibold mb-3">Paint Protection: Advanced Solutions for Lasting Beauty</h3>
      <p className="mb-6 leading-relaxed">
      ...
      <h3 className="text-xl md:text-2xl font-semibold mb-3">Why Professional Detailing Matters</h3>
      <p className="mb-6 leading-relaxed">
      ...
      <h3 className="text-xl md:text-2xl font-semibold mb-3">Finding the Right Service for Your Vehicle</h3>
      <p className="mb-6 leading-relaxed">
